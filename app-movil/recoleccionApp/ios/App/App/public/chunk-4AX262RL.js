...
var DESCRIPTOR_KEY = "faceDescriptorMP";
var CDN_BASE = "https://cdn.jsdelivr.net/npm/@mediapipe/face_mesh";
var SIMILARITY_THRESHOLD = 0.15;
var _FaceRecognitionService = class _FaceRecognitionService {
  constructor() {
    this.faceMesh = null;
  ...
  _extraerLandmarksInterno(base64) {
    return new Promise((resolve) => {
      const img = new Image();
      img.onload = () => __async(this, null, function* () {
        ...
        this.faceMesh.onResults((results) => {
          if (results.multiFaceLandmarks?.length > 0) {
            ...
            resultado = landmarks.flatMap((p) => [p.x, p.y, p.z]);
          }
        });
        try {
          yield this.faceMesh.send({ image: canvas });
          resolve(resultado);
        } catch (e) {
  ...
  guardarDescriptorReferencia(landmarks) {
    return __async(this, null, function* () {
  ...
  cargarDescriptorReferencia() {
    return __async(this, null, function* () {
      const { value } = yield Preferences.get({ key: DESCRIPTOR_KEY });
  ...
  verificarIdentidad(base64Actual) {
    return __async(this, null, function* () {
      const referencia = yield this.cargarDescriptorReferencia();
      if (!referencia) {
        return {
          verificado: false,
          confianza: 0,
      ...
      let actual;
      try {
        actual = yield this.extraerLandmarks(base64Actual);
      } catch {
        return {
          verificado: false,
          confianza: 0,
      ...
      if (!actual) {
        return {
          verificado: false,
          confianza: 0,
          error: "No se detect\xF3 ning\xFAn rostro. Mira de frente con buena iluminaci\xF3n."
        };
      }
  ...
  borrarDescriptor() {
    return __async(this, null, function* () {
      yield Preferences.remove({ key: DESCRIPTOR_KEY });
      this.modelReady = false;
      this.faceMesh = null;
    });
  }
};
_FaceRecognitionService.\u0275fac = function FaceRecognitionService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _FaceRecognitionService)();
};
_FaceRecognitionService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _FaceRecognitionService, factory: _FaceRecognitionService.\u0275fac, providedIn: "root" });
var FaceRecognitionService = _FaceRecognitionService;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(FaceRecognitionService, [{
    type: Injectable,
...
//# sourceMappingURL=chunk-4AX262RL.js.map
